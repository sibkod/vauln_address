<template>
  <div class="roadmap-header">
    <h2>Roadmap</h2>
    <p class="roadmap-sub">Development path toward comprehensive wallet security</p>
  </div>
  ...
  <div class="roadmap-timeline">
    <div class="roadmap-phase completed">
      ...
      <div class="phase-content">
        <h3>Multi‑Chain Checker</h3>
        <ul>
          <li>5 chains: EVM, BTC, Solana, Sui, Tron</li>
          <li>1,000+ database entries</li>
          <li>Live alerts & web3 auth</li>
          <li>Credit system for paid checks</li>
        </ul>
    ...
    <div class="roadmap-phase in-progress">
      ...
      <div class="phase-content">
        <h3>Smart Contract & Drainer Detection</h3>
        <ul>
          <li>Advanced drainer pattern analysis</li>
          <li>Suspicious contract interaction alerts</li>
    ...
    <div class="roadmap-phase planned">
      ...
      <div class="phase-content">
        ...
        <ul>
          <li>Comprehensive hacker database</li>
          <li>Cross‑chain address clustering</li>
          <li>Transaction flow visualization</li>
          <li>Developer API</li>
        </ul>
        <span class="phase-date">Planned · Q3–Q4 2026</span>
      </div>
    </div>
    ...
    <div class="roadmap-phase future">
      ...
      <div class="phase-content">
        ...
        <ul>
          ...
          <li>Automated honeypot detection</li>
